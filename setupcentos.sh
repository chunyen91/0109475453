...
# --------- Mirror Repo --------------
wget https://raw.githubusercontent.com/chunyen91/0109475453/master/centool/epel-release-6-8.noarch.rpm
wget https://raw.githubusercontent.com/chunyen91/0109475453/master/centool/remi-release-6.rpm
rpm -Uvh epel-release-6-8.noarch.rpm
rpm -Uvh remi-release-6.rpm
if [ "$OS" == "x86_64" ]; then
  wget https://raw.githubusercontent.com/chunyen91/0109475453/master/centool/rpmforge-release-0.5.3-1.el6.rf.x86_64.rpm
  rpm -Uvh rpmforge-release-0.5.3-1.el6.rf.x86_64.rpm
# else
  wget https://raw.githubusercontent.com/chunyen91/0109475453/master/centool/rpmforge-release-0.5.3-1.el6.rf.i686.rpm
...
# install badvpn
wget -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/chunyen91/0109475453/master/repo/badvpn-udpgw"
if [ "$OS" == "x86_64" ]; then
  wget -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/chunyen91/0109475453/master/repo/badvpn-udpgw64"
fi
...
visible_hostname Proxy.anaksabah.net
END
...
# install webmin
cd
wget "https://raw.githubusercontent.com/chunyen91/0109475453/master/webmin-1.801-1.noarch.rpm"
...
echo ""  | tee -a log-install.txt
echo "----------- Script Created By Steven Indarto(fb.com/samreysteven) ------------"
